...
namespace DayOff.Web.Controllers
{
    ...
    public class LeaveRequestsController : Controller
    {
        ...
        {
            var model = await leaveRequestRepository.GetLeaveDetails();
            return View(model);
        }
        ...
        public async Task<IActionResult> Create(LeaveRequestCreateVM model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    ModelState.AddModelError(string.Empty, "You have exceeded your allocation limit!");
                }
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StartDate,EndDate,LeaveTypeId,DateRequested,RequestComments,Approved,Cancelled,RequestingEmployeeId,Id,CreatedAt,UpdatedAt")] LeaveRequest leaveRequest)
        {
