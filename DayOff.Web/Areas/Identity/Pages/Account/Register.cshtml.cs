...
namespace DayOff.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.CreatedAt = Input.CreatedAt ?? default;

                // CreateAsync hashes the user password before storing in the database
